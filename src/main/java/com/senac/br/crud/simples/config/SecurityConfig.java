...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(request -> request.requestMatchers("/", "/add_pessoa", "/styles/*", "/cad_pessoa", "/login" , "/indexstyle.css" , "/filmes.jpg" , "/inicio.css" , "/logadostyle.css" , "/style.css").permitAll()
